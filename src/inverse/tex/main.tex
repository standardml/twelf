...
$$
\begin{array}{llll}
\mathbf{Substitutions} & \sigma & ::= & \IdSub \Spb M\cdot\sigma \Spb \Shift^n \Spb \sigma_1\Comp\sigma_2\\
\end{array} 
$$

(The notation $\Shift$ means $\Shift^1$.)  
...
\input{../NW_TEX/sequent.tex}

%% \appendix

%% \section{Structures}
%% \input{../NW_TEX/context.tex}
%% \input{../NW_TEX/signat.tex}

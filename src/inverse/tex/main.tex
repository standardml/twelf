...
$$
\begin{array}{c}
\infer{\Long{a\cdot S}}{\Skel{\Sigma(a)}{\tauskel} & \card{S} = n & \LongAt{S}{\tauskel}} \\\\
...
$$
\begin{array}{c}
\infer{\LongAt{i\cdot S}{\SkBase}}{\Gamma(i) = \tauskel & \card{S} = n & \LongAt{S}{\tauskel}}\\\\
\infer{\LongAt{c\cdot S}{\SkBase}}{\Skel{\Sigma(c)}{\tauskel} & \card{S} = n & \LongAt{S}{\tauskel}}\\\\
...
\infer{\Long{\PiTyp{A}{K}}{\PiTyp{A'}{K'}}}{\Long{A}{A'} & \Skel{A'}{\tau} & \Long[\Gamma,\tau]{K}{K'}}
\end{array} 
$$
...
$$
\begin{array}{c}
\infer{\Long{a\cdot S}{a\cdot S'}}{\Skel{\Sigma(a)}{\tauskel} & \card{S} = n & \LongAt{S}{\tauskel}{S'}} \\\\
...
$$
\begin{array}{c}
\infer{\LongAt{i\cdot S}{\SkBase}{i\cdot S'}}{\Gamma(i) = \tauskel & \card{S} = n & \LongAt{S}{\tauskel}{S'}}\\\\
\infer{\LongAt{i\cdot S}{\tau_1\to\tau_2}{M}}{\LongAt{\Lam{i\cdot(S[\Shift] \Concat 1)}}{\tau_1\to\tau_2}{M}}\\\\
\infer{\LongAt{c\cdot S}{\SkBase}{c\cdot S'}}{\Skel{\Sigma(c)}{\tauskel} & \card{S} = n & \LongAt{S}{\tauskel}{S'}}\\\\

...
struct
  ...
  *)
  ...
  (* maps midsto module declarations, sizes, and containing module; size is -1 if the module is still open *)
  ...
  fun modOpen(dec) =
     let
        ...
        val _ = IH.insert modTable (m, (dec, ~1, SOME parent))
     in
     	m
     end
  fun modClose() =
    ...
    then raise Error("no open module to close")
      ...
      let
         ...
         (* FR: check totality and clash-freeness of views *)
      in
         ()
      end

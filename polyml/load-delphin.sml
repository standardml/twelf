...
(* Note that there is a solvers-polyml, which
...
use "src/delphin/ml-yacc-lib-mod/base.sig";
use "src/delphin/ml-yacc-lib-mod/lrtable.sml";
use "src/delphin/ml-yacc-lib-mod/stream.sml";
use "src/delphin/ml-yacc-lib-mod/parser2.sml";
use "src/delphin/ml-yacc-lib-mod/join.sml";
use "src/delphin/dextsyn.sig";
use "src/delphin/dextsyn.fun";
use "src/delphin/delphin.grm.sig";
use "src/delphin/delphin.grm.sml";
use "src/delphin/interface.sig";
use "src/delphin/interface.fun";
use "src/delphin/delphin.lex.sml";
use "src/delphin/parse-prg.sig";
use "src/delphin/parse-prg.fun";
use "src/delphin/trans.fun";
use "src/delphin/trans.sig";
use "src/delphin/delphin.sig";
use "src/delphin/delphin.fun";
use "src/delphin/delphin.sml";

...
use "src/lambda/trail.sig";
use "src/lambda/trail.fun";
use "src/lambda/notrail.fun";
...
use "src/table/redblack.sml";
use "src/table/hash.sml";
...
use "src/heuristic/heuristic.fun";
